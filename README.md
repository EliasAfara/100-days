...
- [ ] Complete [The Odin Project](https://www.theodinproject.com) full JavaScript track
- [ ] In depth modern JavaScript
- [ ] In depth React
- [ ] Static site generator
- [ ] Build renovated personal website
- [ ] Headless CMS
- [ ] Flutter
- [ ] POS Ecosystem project

## Moving forward - Beyond the 100 days
- [ ] freeCodeCamp
- [ ] Coding Challenges 

## Table of Contents

* [The fundamental blocks of web development](#-the-fundamental-blocks-of-web-development)
...
* [Flutter](#-flutter)
* [POS Ecosystem](#-pos-ecosystem)
* [Moving Forward](#-moving-forward)

---

## ➤ The fundamental blocks of web development

For the fundamentals, I'll be heavily relying on [the Web Skills resources](https://andreasbm.github.io/web-skills/?compact) by [Andreas Mehlsen](https://github.com/andreasbm).
...
Complete the lessons on [The Odin Project](https://www.theodinproject.com) from the full JS track:
...
The main goal of this section is to fill the gaps in JS coding. Mostly scanning because I know them already, but necessary nontheless.
...
* [ ] Traversy Media crash course: [Youtube](https://www.youtube.com/watch?v=sBws8MSXN7A)
* [ ] Read the [React Docs](https://reactjs.org/)
* [ ] React Projects by Travery Media: [Youtube](https://www.youtube.com/playlist?list=PLillGF-RfqbY3c2r0htQyVbDJJoBFE6Rb)

---

## ➤ Static site generator

I have two of them in mind, to be decided between:
...
To be built with the static site generator learned earlier and hosted on [Netlify](https://www.netlify.com/).  

On the side learning to use for frontend: 

* [ ] Learn [Tailwind](https://tailwindcss.com/)  

Website sections to complete:
...
**Note:** RSS feed for tech and blog are separate.

---

## ➤ Headless CMS

Check the available options, go over them, try them, then stick to one and learn it in details. For general overviews, check [headlessCMS](https://headlesscms.org/).  
...
* [ ] [Flutter Projects](https://www.packtpub.com/mobile/flutter-projects)
...
* [ ] [Flutter Recipes](https://www.amazon.com/Flutter-Recipes-Development-Solutions-Android/dp/148424981X)

### Must Read

* [ ] [Flutter Docs](https://flutter.dev/docs)
* [ ] [Dart Docs](https://dart.dev/guides)
* [ ] [Flutter design docs](https://flutter.dev/docs/resources/design-docs)
...
Complete POS system that acts as a final project for this roadmap and combines everything learned during this timespan.

### Project architecture

* [ ] Data models
* [ ] Tech stack documentation
* [ ] Details for below sections

### Headless CMS for Data
...
[freeCodeCamp](https://www.freecodecamp.org/) offers many tracks and certifications that tackle the fundamentals in several fields. I'll keep learning from there daily in order to remember stuff I already know or learn new things. 

### Coding Challenges 

In order to always keep my mind fresh and polish my problem solving skills, I will consistently solve coding challenges. 

Most probably I'll stick to:
* [Code Wars](https://www.codewars.com).
* [CodinGame](https://www.codingame.com)

There are also other options that can be considered:
